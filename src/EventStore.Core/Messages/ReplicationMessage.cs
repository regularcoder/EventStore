...
namespace EventStore.Core.Messages
{
    public static class ReplicationMessage
    {
        ...
        public class SubscribeToMaster : Message, IReplicationMessage
        {
            ...
            Guid IReplicationMessage.MasterId { get { return MasterId; } }
            Guid IReplicationMessage.SubscriptionId { get { return SubscriptionId; } }
        ...
        public class ReplicaSubscribed : Message, IReplicationMessage
        {
            ...
            public ReplicaSubscribed(Guid masterId, Guid subscriptionId, long subscriptionPosition, IPEndPoint masterEndPoint)
            {
                Ensure.NotEmptyGuid(masterId, "masterId");
                Ensure.NotEmptyGuid(subscriptionId, "subscriptionId");
                Ensure.Nonnegative(subscriptionPosition, "subscriptionPosition");
        ...
        public class CreateChunk : Message, IReplicationMessage
        {
            ...
            {
                return string.Format("CreateChunk message: MasterId: {0}, SubscriptionId: {1}, ChunkHeader: {2}, FileSize: {3}, IsCompletedChunk: {4}",
        ...
        public class RawChunkBulk : Message, IReplicationMessage
        {
            ...
            public override string ToString()
            {
                return string.Format("RawChunkBulk message: MasterId: {0}, SubscriptionId: {1}, ChunkStartNumber: {2}, ChunkEndNumber: {3}, RawPosition: {4}, RawBytes length: {5}, CompleteChunk: {6}",
        ...
        public class ReplicationAckCheckTick : Message
        {
            private static readonly int TypeId = System.Threading.Interlocked.Increment(ref NextMsgId);
            public override int MsgTypeId { get { return TypeId; } }

            public ReplicationAckCheckTick()
            {
            }
        }
